    ...
    <a-card title="添加基本信息">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="175px" class="form-div">
        ...
        <el-form-item label="民族 :" class="form-item-div">
          <el-select v-model="ruleForm.nation" placeholder="请选择" style="width: 100%;" size="medium">
            <el-option label value></el-option>
        ...
        <el-form-item label="受教育年数 :" class="form-item-div">
          <a-input-number
            v-model="ruleForm.educationYears"
            placeholder="请输入数字值（单位：年）"
            :style="{width:'100%'}"
          />
        </el-form-item>
        ...
        <!-- 如果仍在吸烟 -->
        <el-form-item label="一天抽几支 :" class="form-item-div" v-if="showSmoke">
          <a-input-number
            v-model="ruleForm.smokingNumEachDay"
            placeholder="请输入数字值（单位：支）"
            :style="{width:'100%'}"
          />
        </el-form-item>
        ...
        <!-- 如果仍在喝酒 -->
        <el-form-item label="一天几两 :" class="form-item-div" v-if="showDrink">
          <a-input-number
            v-model="ruleForm.drinkingNumEachDay"
            placeholder="请输入数字值（单位：两）"
            :style="{width:'100%'}"
          />
        </el-form-item>
        ...
        <el-form-item label="体格检查情况 :" class="form-item-div">
          <el-input
            ...
            maxlength="300"
            show-word-limit
            v-model="ruleForm.physicalExamination"
            size="medium"
            placeholder="请输入"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="具体药物的剂量 :" class="form-item-div" v-if="showCognitiveDrug">
          <a-input-number
