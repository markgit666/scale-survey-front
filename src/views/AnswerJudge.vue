        ...
        <a-card>
          ...
          <div v-for="(oneQuestion, oneQuestionId) in scaleAnswerInfo.scaleInfo.questionList">
            ...
            <div v-if="oneQuestion.questionType==='questionType'">
              <a-divider
                :style="{fontFamily:'SimHei',fontWeight:'bold' }"
                orientation="left"
              >{{oneQuestion.title}}</a-divider>
            </div>
            <!--2. 指导语-->
              ...
              <el-row :gutter="10">
                ...
                <el-col :lg="8" :md="8" :sm="8" :xl="8" :xs="8">
                  ...
                  <el-input-number
                    ...
                    :style="{width:'50%'}"
                    size="small"
                    v-model="oneQuestion.answer.score"
                  ></el-input-number>
                </el-col>
              </el-row>
            </div>
              ...
              <el-row :gutter="10">
                ...
                <el-col :lg="8" :md="8" :sm="8" :xl="8" :xs="8">
                  ...
                  <div v-for="(item,itemId) in oneQuestion.items">
                    <p :style="{fontFamily:'SimHei'}">{{item.option}}</p>
                  </div>
                </el-col>
                <!--答案-->
                <el-col :lg="8" :md="8" :sm="8" :xl="8" :xs="8">
...
export default {
  ...
  methods: {
    ...
    fetch() {
      let that = this;
      axios
        .post(this.serverUrl + "paper/scale/detail", this.$route.query, {
          headers: {
    ...
    saveModifyScore() {
      ...
      that.JudgeInfo.examinationPaperId = sessionStorage.getItem(
        "examinationPaperId"
      );
