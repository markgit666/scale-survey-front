<template>
  ...
  <div>
    ...
    <a-row>
      ...
      <a-col :xs="20" :sm="16" :md="20" :lg="20" :xl="20">
        ...
        <div :style="{marginTop:'15px'}">
          <center>
            <h3><strong>{{scaleAnswerInfo.scaleInfo.scaleName}}</strong></h3>
          </center>
        </div>
      </a-col>
      <a-col :xs="2" :sm="4" :md="2" :lg="2" :xl="2"></a-col>
      ...
      <a-row>
        ...
        <a-col :xs="20" :sm="16" :md="20" :lg="20" :xl="20">
          <a-card :style="{height:'120px',marginTop:'10px'}" :bordered="false" :hoverable="true">
            ...
            {{scaleAnswerInfo.scaleInfo.scaleId}}
    ...
    <!--所有题目 开始-->
    <div
      v-for="(oneQuestion, oneQuestionId) in scaleAnswerInfo.scaleInfo.questionList"
      :key="oneQuestionId"
    >
      <!-- 1.如果是问答题 -->
    ...
    methods: {
        ...
        axios
          ...
          .then(response => {
            ...
            if (response.data.retCode === '000000') {
              ...
              if (that.scaleAnswerInfo.judgeInfo != null) {
                that.JudgeInfo.examinationPaperId = that.scaleAnswerInfo.examinationPaperId
                that.JudgeInfo.checkUser = that.scaleAnswerInfo.judgeInfo.checkUser
                that.JudgeInfo.totalScore = that.scaleAnswerInfo.judgeInfo.totalScore
              }
      ...
      saveScore () {
        if (this.JudgeInfo.checkUser === '') {
          ...
          // 得到答卷Id
          this.JudgeInfo.examinationPaperId = this.scaleAnswerInfo.examinationPaperId
