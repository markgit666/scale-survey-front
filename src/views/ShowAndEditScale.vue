<template>
  ...
  <!--      &lt;!&ndash; <a href="#" slot="extra" @click="toggle" :style="{marginLeft:'10px'}">编辑</a> &ndash;&gt;-->
  <!--    </a>-->
  ...
  <div>
    ...
    <div :style="{ overflow: 'initial' }">
      ...
      <div :style="{  textAlign: 'center'}">
        ...
        <a-card :hoverable="true" :bordered="false" :style="{height:'80px',marginTop:'15px'}">
      ...
      <a-card :hoverable="true" :bordered="false" class="father"
        ...
        <center>
          ...
          <a-button class="save_button" type="primary" @click="backTotalScale" :style="{marginLeft:'15px'}">返回</a-button>
