        ...
        <a-col :xs="22" :sm="22" :md="22" :lg="22" :xl="22">
          <a-card>
            ...
            <el-tabs :tab-position="tabPosition" style="height: 300px;">
              ...
              <el-tab-pane v-if="showContent" label="AD组入组标准/排除标准">配置管理</el-tab-pane>

              <el-tab-pane label="MCI组入组标准/排除标准">角色管理</el-tab-pane>
              <el-tab-pane label="临床基本资料">定时任务补偿</el-tab-pane>
              <el-tab-pane label="实验室资料">定时任务补偿</el-tab-pane>
              <el-tab-pane label="开始训练">开始训练</el-tab-pane>
            </el-tabs>
          </a-card>
        </a-col>
        <a-col :xs="1" :sm="1" :md="1" :lg="1" :xl="1"></a-col>
      ...
      <div v-show="show">
        <div>
                  ...
                  <a-row>
                    ...
                    <a-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
                      <a-card :style="{height:'100%',marginTop:'15px'}" :bordered="false">
                        ...
                        <label>
                          <strong>(画图题)&nbsp&nbsp作答要求：</strong>
                        </label>
                        {{value.title}}
                      ...
                      <a-card :bordered="false">
                        <a-row type="flex" justify="space-around">
                          ...
                          <a-col :span="4">
                            <a-button
                              type="primary"
                              @click="handleChangeImage(subjectId,value.questionId)"
                            >保存图片</a-button>
                          </a-col>
                        </a-row>
                      </a-card>
              ...
              <a-row>
                ...
                <a-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
                  <a-card :style="{height:'100%',marginTop:'15px'}" :bordered="false">
                    ...
                    <label>
                      <strong>(图片题)&nbsp&nbsp作答要求：</strong>
                    </label>
                    {{value.title}}
                    <div v-for="(one, index) in answer.answerList" :key="index">
                      <div v-if="value.questionId === one.questionId">
          ...
          <a-row>
            ...
            <a-col :xs="20" :sm="20" :md="20" :lg="20" :xl="20">
              <a-card
                :style="{height:'130px',marginTop:'10px',marginBottom:'20px'}"
                :bordered="false"
              >
                <center>
                  <h3>
                    <strong>如您已完成此量表，请保存！</strong>
                  </h3>
                </center>
                <center>
                  <a-button
